...
int mk_sha2_224_test_examples(void)
{
	...
	struct mk_hash_sha2_224_s mk_sha2_224;
	...
	for(i = 0; i != sizeof(s_tasks) / sizeof(s_tasks[0]); ++i)
	{
		...
		mk_hash_sha2_224_init(&mk_sha2_224);
		mk_hash_sha2_224_append(&mk_sha2_224, msg, msg_len);
		mk_hash_sha2_224_finish(&mk_sha2_224, &computed);
