...
int mk_sha2_512224_test_examples(void)
{
	...
	struct mk_hash_sha2_512224_s mk_sha2_512224;
	...
	for(i = 0; i != sizeof(s_tasks) / sizeof(s_tasks[0]); ++i)
	{
		...
		mk_hash_sha2_512224_init(&mk_sha2_512224);
		mk_hash_sha2_512224_append(&mk_sha2_512224, msg, msg_len);
		mk_hash_sha2_512224_finish(&mk_sha2_512224, &computed);
