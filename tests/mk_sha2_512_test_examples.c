...
int mk_sha2_512_test_examples(void)
{
	...
	struct mk_hash_hash_sha2_512_s mk_sha2_512;
	...
	for(i = 0; i != sizeof(s_tasks) / sizeof(s_tasks[0]); ++i)
	{
		...
		mk_hash_hash_sha2_512_init(&mk_sha2_512);
		mk_hash_hash_sha2_512_append(&mk_sha2_512, msg, msg_len);
		mk_hash_hash_sha2_512_finish(&mk_sha2_512, &computed);
