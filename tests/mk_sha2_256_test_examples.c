...
int mk_sha2_256_test_examples(void)
{
	...
	struct mk_hash_hash_sha2_256_s mk_sha2_256;
	...
	for(i = 0; i != sizeof(s_tasks) / sizeof(s_tasks[0]); ++i)
	{
		...
		mk_hash_hash_sha2_256_init(&mk_sha2_256);
		mk_hash_hash_sha2_256_append(&mk_sha2_256, msg, msg_len);
		mk_hash_hash_sha2_256_finish(&mk_sha2_256, &computed);
