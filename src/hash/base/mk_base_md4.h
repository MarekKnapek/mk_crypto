#ifndef mk_include_guard_base_md4
#define mk_include_guard_base_md4
...
enum mk_md4_base_block_len_e{ mk_md4_base_block_len = 64 };
enum mk_md4_base_digest_len_e{ mk_md4_base_digest_len = 16 };
