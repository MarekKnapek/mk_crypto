...
mk_jumbo void mk_hash_base_detail_sha2_512_finish(struct mk_hash_base_detail_sha2_512_s* hash_base_detail_sha2_512, void* block, int idx, void* digest)
{
	...
	if(capacity >= 16)
	{
		...
		mk_hash_base_detail_sha2_512_append_blocks(hash_base_detail_sha2_512, 1, input);
	}
	else
	{
		...
		mk_hash_base_detail_sha2_512_append_blocks(hash_base_detail_sha2_512, 1, buff);
	}
