#ifndef mk_include_guard_base_sha3_rawshake256
#define mk_include_guard_base_sha3_rawshake256
...
enum mk_sha3_rawshake256_base_block_len_e{ mk_sha3_rawshake256_base_block_len = 136 };
