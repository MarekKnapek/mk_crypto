...
{
	mk_assert(hash_function);

	return (enum mk_hash_function_e)mk_hash_fn_get_type((struct mk_hash_fn_s*)hash_function);
}
...
mk_jumbo void mk_hash_function_append(mk_hash_function_h hash_function, void const* msg, int msg_len)
{
	...
	mk_hash_fn_append((struct mk_hash_fn_s*)hash_function, msg, msg_len);
}
...
mk_jumbo void mk_hash_function_finish(mk_hash_function_h hash_function, void* digest)
{
	...
	mk_hash_fn_finish((struct mk_hash_fn_s*)hash_function, digest);
}
...
mk_jumbo void mk_hash_function_destroy(mk_hash_function_h hash_function)
{
	...
	free((struct mk_hash_fn_s*)hash_function);
}
