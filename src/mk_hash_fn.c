...
mk_jumbo void mk_hash_fn_append(struct mk_hash_fn_s* hash_fn, void const* msg, int msg_len)
{
	...
	{
		case mk_hash_fn_md2: mk_md2_append(&hash_fn->m_state.m_md2, msg, msg_len); break;
		case mk_hash_fn_md4: mk_md4_append(&hash_fn->m_state.m_md4, msg, msg_len); break;
		case mk_hash_fn_md5: mk_md5_append(&hash_fn->m_state.m_md5, msg, msg_len); break;
		case mk_hash_fn_sha1: mk_sha1_append(&hash_fn->m_state.m_sha1, msg, msg_len); break;
		case mk_hash_fn_sha2_224: mk_sha2_224_append(&hash_fn->m_state.m_sha2_224, msg, msg_len); break;
		case mk_hash_fn_sha2_256: mk_sha2_256_append(&hash_fn->m_state.m_sha2_256, msg, msg_len); break;
		case mk_hash_fn_sha2_384: mk_sha2_384_append(&hash_fn->m_state.m_sha2_384, msg, msg_len); break;
		case mk_hash_fn_sha2_512: mk_sha2_512_append(&hash_fn->m_state.m_sha2_512, msg, msg_len); break;
		case mk_hash_fn_sha2_512224: mk_sha2_512224_append(&hash_fn->m_state.m_sha2_512224, msg, msg_len); break;
		case mk_hash_fn_sha2_512256: mk_sha2_512256_append(&hash_fn->m_state.m_sha2_512256, msg, msg_len); break;
		case mk_hash_fn_sha3_224: mk_sha3_224_append(&hash_fn->m_state.m_sha3_224, msg, msg_len); break;
		case mk_hash_fn_sha3_256: mk_sha3_256_append(&hash_fn->m_state.m_sha3_256, msg, msg_len); break;
		case mk_hash_fn_sha3_384: mk_sha3_384_append(&hash_fn->m_state.m_sha3_384, msg, msg_len); break;
		case mk_hash_fn_sha3_512: mk_sha3_512_append(&hash_fn->m_state.m_sha3_512, msg, msg_len); break;
	}
}
